...
INSERT INTO `tb_ekskul` VALUES (2,'Paskibra','Ruslan Didu'),(3,'Pramuka','Royhan Asmr'),(4,'PMR','Ery Zem Boat'),(6,'Marawis','Numan Sike'),(12,'Hadroh','Ghugus Santri');
...
INSERT INTO `tb_ekskul_nilai` VALUES (1,2,3,4,78),(4,2,1,5,NULL),(6,2,3,6,83),(7,6,3,6,89),(8,6,1,5,NULL);
...
INSERT INTO `tb_guru` VALUES (1,'GAD57220','Wahid Okkotsu','8234287364279',NULL,'guru','Kembangan Utara','082123827346','wahidcllucetia@gmail.com'),(3,'GAD71785','Royhan Assalam','',NULL,'guru','Duri Kosambi','0823812682734','royunderated@gmail.com'),(5,'GAD87151','Rivansyah','',NULL,'guru','Tangerang','0821287462873','riv@vansyah.com');
...
INSERT INTO `tb_mata_pelajaran` VALUES (3,'Matematika','1'),(4,'Bahasa Indonesia','1'),(6,'Ilmu Pengetahuan Alam','1'),(7,'Matematika','3');
...
CREATE TABLE `tb_nilai_siswa` (
  ...
  `nilai_smts` int DEFAULT NULL,
  `semester` varchar(20) DEFAULT NULL,
  `tp_nilai` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `tb_nilai_siswa` WRITE;
/*!40000 ALTER TABLE `tb_nilai_siswa` DISABLE KEYS */;
INSERT INTO `tb_nilai_siswa` VALUES (1,6,1,5,NULL,NULL,NULL,'2025/2026'),(2,4,1,5,87,79,NULL,'2025/2026'),(3,7,3,4,78,99,NULL,'2025/2026'),(4,7,3,6,NULL,NULL,NULL,'2025/2026');
/*!40000 ALTER TABLE `tb_nilai_siswa` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_rombel` VALUES (1,'1','1A','2025/2026',3,25),(2,'2','2A','2025/2026',3,30),(3,'1','1B','2025/2026',1,27),(8,'2','2B','2025/2026',3,30),(9,'3','3A','2025/2026',1,20);
...
INSERT INTO `tb_rombel_set` VALUES (22,1,5),(23,3,4),(24,3,6);
...
-- Dump completed on 2026-05-12 19:47:25
